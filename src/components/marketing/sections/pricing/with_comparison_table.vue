    ...
    >
      ...
      <div class="max-w-2xl mx-auto lg:hidden">
        ...
        <table class="mt-8 w-full">
          <caption
            class="bg-gray-50 border-t border-gray-200 py-3 px-4 text-sm leading-5 font-medium text-gray-900 text-left"
          >
            Features
          </caption>
          <thead>
            ...
            <!-- <tr>
              ...
              <td class="h-full py-8 px-6 align-top">
                <div class="relative h-full table">
                  <p>
                    <span
                      class="text-4xl leading-10 font-extrabold text-gray-900"
                      >$9</span
                    >
                    <span class="text-base leading-6 font-medium text-gray-500"
                      >/mo</span
